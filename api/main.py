...
from api.ml_prediction import RecursivePredictionRequest
from api.ml_prediction import get_model_info
from api.ml_prediction import predict_demand
from api.ml_prediction import predict_recursive_demand
...
@app.post("/api/ml/predict-recursive")
def ml_predict_recursive(payload: RecursivePredictionRequest) -> dict:
    return predict_recursive_demand(payload).dict()
